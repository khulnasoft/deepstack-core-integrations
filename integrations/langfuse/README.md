...
[![PyPI - Version](https://img.shields.io/pypi/v/langfuse-deepstack.svg)](https://pypi.org/project/langfuse-deepstack)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/langfuse-deepstack.svg)](https://pypi.org/project/langfuse-deepstack)
...
To install langfuse-deepstack, run the following command:
...
To enable tracing in your Deepstack pipeline, add the `LangfuseConnector` to your pipeline.
...
Langfuse provides a user-friendly interface to visualize and analyze the traces generated by your Deepstack pipeline. Login into your Langfuse account and navigate to the trace URL to view the trace details.
