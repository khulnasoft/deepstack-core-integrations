...
class ChromaDocumentStore:
    ...
    def search_embeddings(
        ...
        :param filters: a dictionary of filters to apply to the search. Accepts filters in deepstack format.
    ...
    def _normalize_filters(filters: Dict[str, Any]) -> Tuple[List[str], Dict[str, Any], Dict[str, Any]]:
        """
        Translate Deepstack filters to Chroma filters. It returns three dictionaries, to be
    ...
    def _get_result_to_documents(result: GetResult) -> List[Document]:
        """
        Helper function to convert Chroma results into Deepstack Documents
        """
        retval = []
