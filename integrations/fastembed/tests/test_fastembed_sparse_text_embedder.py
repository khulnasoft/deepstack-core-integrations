...
import numpy as np
import pytest
from deepstack import default_from_dict
from deepstack.dataclasses.sparse_embedding import SparseEmbedding
from deepstack_integrations.components.embedders.fastembed.fastembed_sparse_text_embedder import (
...
class TestFastembedSparseTextEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert embedder_dict == {
            "type": "deepstack_integrations.components.embedders.fastembed.fastembed_sparse_text_embedder.FastembedSparseTextEmbedder",  # noqa
            "init_parameters": {
                "model": "prithvida/Splade_PP_en_v1",
                "cache_dir": None,
                "threads": None,
    ...
    @patch(
        "deepstack_integrations.components.embedders.fastembed.fastembed_sparse_text_embedder._FastembedSparseEmbeddingBackendFactory"
    )
