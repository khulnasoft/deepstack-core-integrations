...
from deepstack_integrations.components.embedders.fastembed.fastembed_document_embedder import (
...
class TestFastembedDocumentEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert embedder_dict == {
            "type": "deepstack_integrations.components.embedders.fastembed.fastembed_document_embedder.FastembedDocumentEmbedder",  #  noqa
            "init_parameters": {
                "model": "BAAI/bge-small-en-v1.5",
                "cache_dir": None,
                "threads": None,
    ...
    @patch(
        "deepstack_integrations.components.embedders.fastembed.fastembed_document_embedder._FastembedEmbeddingBackendFactory"
    )
