...
from deepstack_integrations.components.embedders.fastembed.embedding_backend.fastembed_backend import (
    _FastembedEmbeddingBackendFactory,
)


@patch("deepstack_integrations.components.embedders.fastembed.embedding_backend.fastembed_backend.TextEmbedding")
