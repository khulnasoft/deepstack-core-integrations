...
from deepstack_integrations.components.embedders.fastembed.fastembed_text_embedder import (
...
class TestFastembedTextEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert embedder_dict == {
            "type": "deepstack_integrations.components.embedders.fastembed.fastembed_text_embedder.FastembedTextEmbedder",  # noqa
            "init_parameters": {
                "model": "BAAI/bge-small-en-v1.5",
                "cache_dir": None,
                "threads": None,
    ...
    @patch(
        "deepstack_integrations.components.embedders.fastembed.fastembed_text_embedder._FastembedEmbeddingBackendFactory"
    )
