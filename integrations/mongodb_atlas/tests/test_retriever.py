...
from deepstack.utils.auth import EnvVarSecret
...
class TestRetriever:
    ...
    def mock_client(self):
        with patch(
            "deepstack_integrations.document_stores.mongodb_atlas.document_store.MongoClient"
    ...
    def test_to_dict(self, mock_client, monkeypatch):  # noqa: ARG002  mock_client appears unused but is required
        ...
        assert res == {
            "type": "deepstack_integrations.components.retrievers.mongodb_atlas.embedding_retriever.MongoDBAtlasEmbeddingRetriever",  # noqa: E501
            "init_parameters": {
                "document_store": {
                    "type": "deepstack_integrations.document_stores.mongodb_atlas.document_store.MongoDBAtlasDocumentStore",  # noqa: E501
                    "init_parameters": {
    ...
    def test_from_dict(self, mock_client, monkeypatch):  # noqa: ARG002  mock_client appears unused but is required
        ...
        assert document_store.database_name == "deepstack_integration_test"
