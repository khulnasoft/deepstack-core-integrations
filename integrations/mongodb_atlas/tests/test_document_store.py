...
from deepstack.testing.document_store import DocumentStoreBaseTests
...
class TestDocumentStore(DocumentStoreBaseTests):
    ...
    def document_store(self):
        database_name = "deepstack_integration_test"
        collection_name = "test_collection_" + str(uuid4())

        connection: MongoClient = MongoClient(
            os.environ["MONGO_CONNECTION_STRING"], driver=DriverInfo(name="MongoDBAtlasDeepstackIntegration")
        )
    ...
    def test_to_dict(self, document_store):
        ...
        assert serialized_store == {
            "type": "deepstack_integrations.document_stores.mongodb_atlas.document_store.MongoDBAtlasDocumentStore",
            "init_parameters": {
    ...
    def test_from_dict(self):
        ...
        assert docstore.database_name == "deepstack_integration_test"
