...
import pytest
from deepstack_integrations.components.retrievers.weaviate import WeaviateEmbeddingRetriever
from deepstack_integrations.document_stores.weaviate import WeaviateDocumentStore
...
def test_to_dict(_mock_weaviate):
    ...
    assert retriever.to_dict() == {
        "type": "deepstack_integrations.components.retrievers.weaviate.embedding_retriever.WeaviateEmbeddingRetriever",
        "init_parameters": {
            "filters": {},
            "top_k": 10,
            "distance": None,
...
def test_from_dict(_mock_weaviate):
    retriever = WeaviateEmbeddingRetriever.from_dict(
        {
            "type": "deepstack_integrations.components.retrievers.weaviate.embedding_retriever.WeaviateEmbeddingRetriever",  # noqa: E501
            "init_parameters": {
                "filters": {},
                "top_k": 10,
                "distance": None,
...
@patch("deepstack_integrations.components.retrievers.weaviate.bm25_retriever.WeaviateDocumentStore")
