...
from deepstack_integrations.components.retrievers.weaviate import WeaviateBM25Retriever
...
def test_to_dict(_mock_weaviate):
    ...
    assert retriever.to_dict() == {
        "type": "deepstack_integrations.components.retrievers.weaviate.bm25_retriever.WeaviateBM25Retriever",
        "init_parameters": {
            "filters": {},
            "top_k": 10,
            "document_store": {
