...
from deepstack.document_stores.errors import DocumentStoreError
from deepstack.testing.document_store import (
    TEST_EMBEDDING_1,
    TEST_EMBEDDING_2,
    CountDocumentsTest,
    DeleteDocumentsTest,
...
from deepstack_integrations.document_stores.weaviate.auth import AuthApiKey
from deepstack_integrations.document_stores.weaviate.document_store import (
...
class TestWeaviateDocumentStore(CountDocumentsTest, WriteDocumentsTest, DeleteDocumentsTest, FilterDocumentsTest):
    ...
    def filterable_docs(self) -> List[Document]:
        """
        This fixture has been copied from deepstack/testing/document_store.py and modified to
    ...
    @patch("deepstack_integrations.document_stores.weaviate.document_store.weaviate.WeaviateClient")
    ...
    @patch("deepstack_integrations.document_stores.weaviate.document_store.weaviate")
    def test_to_dict(self, _mock_weaviate, monkeypatch):
        ...
        assert document_store.to_dict() == {
            "type": "deepstack_integrations.document_stores.weaviate.document_store.WeaviateDocumentStore",
            "init_parameters": {
                "url": "http://localhost:8080",
                "collection_settings": {
                    "class": "Default",
    ...
    def test_comparison_greater_than_with_iso_date(self, document_store, filterable_docs):
        """
        This test has been copied from deepstack/testing/document_store.py and modified to
        use a different date format.
