...
@patch("deepstack_integrations.components.generators.google_vertex.text_generator.vertexai")
@patch("deepstack_integrations.components.generators.google_vertex.text_generator.TextGenerationModel")
...
def test_to_dict(_mock_model_class, _mock_vertexai):
    ...
    assert generator.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_vertex.text_generator.VertexAITextGenerator",
        "init_parameters": {
            "model": "text-bison",
