...
@patch("deepstack_integrations.components.generators.google_vertex.code_generator.vertexai")
@patch("deepstack_integrations.components.generators.google_vertex.code_generator.CodeGenerationModel")
...
def test_to_dict(_mock_model_class, _mock_vertexai):
    ...
    assert generator.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_vertex.code_generator.VertexAICodeGenerator",
        "init_parameters": {
            "model": "code-bison",
