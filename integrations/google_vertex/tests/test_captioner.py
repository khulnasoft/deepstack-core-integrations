...
@patch("deepstack_integrations.components.generators.google_vertex.captioner.vertexai")
@patch("deepstack_integrations.components.generators.google_vertex.captioner.ImageTextModel")
...
def test_to_dict(_mock_model_class, _mock_vertexai):
    ...
    assert captioner.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_vertex.captioner.VertexAIImageCaptioner",
        "init_parameters": {
            "model": "imagetext",
