...
from deepstack_integrations.components.generators.google_vertex import VertexAIImageGenerator


@patch("deepstack_integrations.components.generators.google_vertex.image_generator.vertexai")
@patch("deepstack_integrations.components.generators.google_vertex.image_generator.ImageGenerationModel")
...
def test_to_dict(_mock_model_class, _mock_vertexai):
    ...
    assert generator.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_vertex.image_generator.VertexAIImageGenerator",
        "init_parameters": {
            "model": "imagetext",
            "project_id": "myproject-123456",
            "location": None,
