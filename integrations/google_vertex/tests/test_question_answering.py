...
@patch("deepstack_integrations.components.generators.google_vertex.question_answering.vertexai")
@patch("deepstack_integrations.components.generators.google_vertex.question_answering.ImageTextModel")
...
def test_to_dict(_mock_model_class, _mock_vertexai):
    ...
    assert generator.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_vertex.question_answering.VertexAIImageQA",
        "init_parameters": {
            "model": "imagetext",
            "project_id": "myproject-123456",
            "location": None,
