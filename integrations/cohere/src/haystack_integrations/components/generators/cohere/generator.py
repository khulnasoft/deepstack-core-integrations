...
from deepstack.components.generators.utils import deserialize_callback_handler, serialize_callback_handler
...
class CohereGenerator:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.client = Client(api_key=self.api_key.resolve_value(), base_url=self.api_base_url, client_name="deepstack")
