...
from deepstack import component, default_from_dict, default_to_dict
from deepstack.dataclasses import ChatMessage, ChatRole, StreamingChunk
from deepstack.lazy_imports import LazyImport
from deepstack.utils import Secret, deserialize_secrets_inplace
from deepstack.utils.callable_serialization import deserialize_callable, serialize_callable
...
class CohereChatGenerator:
    ...
    Example usage:
    ```python
    from deepstack_integrations.components.generators.cohere import CohereChatGenerator
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.client = cohere.Client(
            api_key=self.api_key.resolve_value(), base_url=self.api_base_url, client_name="deepstack"
        )
