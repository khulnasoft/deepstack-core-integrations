...
from deepstack_integrations.components.embedders.cohere.utils import get_async_response, get_response
...
class CohereDocumentEmbedder:
    ...
    from cohere_deepstack.embedders.document_embedder import CohereDocumentEmbedder
