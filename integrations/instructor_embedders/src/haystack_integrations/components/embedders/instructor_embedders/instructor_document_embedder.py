...
from deepstack.utils import ComponentDevice, Secret, deserialize_secrets_inplace
...
class InstructorDocumentEmbedder:
    ...
    Usage example:
    ```python
    # To use this component, install the "instructor-embedders-deepstack" package.
