...
from deepstack.utils import ComponentDevice, Secret
...
class TestInstructorDocumentEmbedder:
    ...
    def test_to_dict(self):
        ...
        assert embedder_dict == {
            "type": "deepstack_integrations.components.embedders.instructor_embedders.instructor_document_embedder.InstructorDocumentEmbedder",  #  noqa
            "init_parameters": {
                "model": "hkunlp/instructor-base",
    ...
    @patch(
        "deepstack_integrations.components.embedders.instructor_embedders.instructor_document_embedder._InstructorEmbeddingBackendFactory"
    )
