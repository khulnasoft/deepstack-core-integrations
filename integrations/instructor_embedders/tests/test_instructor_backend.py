...
from deepstack_integrations.components.embedders.instructor_embedders.embedding_backend.instructor_backend import (
    _InstructorEmbeddingBackendFactory,
)


@patch(
    "deepstack_integrations.components.embedders.instructor_embedders.embedding_backend.instructor_backend.INSTRUCTOR"
)
