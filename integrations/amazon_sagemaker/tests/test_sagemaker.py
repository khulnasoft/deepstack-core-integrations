...
from deepstack_integrations.components.generators.amazon_sagemaker import SagemakerGenerator
from deepstack_integrations.components.generators.amazon_sagemaker.errors import AWSConfigurationError
...
def test_to_dict(set_env_variables, mock_boto3_session):  # noqa: ARG001
    ...
    mocked_dict = {
        "type": "deepstack_integrations.components.generators.amazon_sagemaker.sagemaker.SagemakerGenerator",
        "init_parameters": {
            "model": "model",
