...
class TestNvidiaDocumentEmbedder:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack_integrations.components.embedders.nvidia.document_embedder.NvidiaDocumentEmbedder",
            "init_parameters": {
    ...
    @patch("deepstack_integrations.components.embedders.nvidia._nvcf_backend.NvidiaCloudFunctionsClient")
