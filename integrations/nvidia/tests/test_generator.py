# SPDX-FileCopyrightText: 2024-present khulnasoft GmbH <info@khulnasoft.com>
#
...
class TestNvidiaGenerator:
    ...
    def test_to_dict(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack_integrations.components.generators.nvidia.generator.NvidiaGenerator",
            "init_parameters": {
                "api_url": None,
    ...
    @patch("deepstack_integrations.components.generators.nvidia._nvcf_backend.NvidiaCloudFunctionsClient")
