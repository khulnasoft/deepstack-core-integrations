...
class QdrantEmbeddingRetriever:
    ...
    from deepstack_integrations.components.retrievers.qdrant import QdrantEmbeddingRetriever
    from deepstack_integrations.document_stores.qdrant import QdrantDocumentStore
...
class QdrantHybridRetriever:
    ...
    Usage example:
    ```python
    from deepstack_integrations.components.retrievers.qdrant import QdrantHybridRetriever
    from deepstack_integrations.document_stores.qdrant import QdrantDocumentStore
    from deepstack.dataclasses import Document, SparseEmbedding
