...
from deepstack.dataclasses import SparseEmbedding
...
from deepstack_integrations.document_stores.qdrant.document_store import QdrantDocumentStore, QdrantStoreError
...
class TestQdrantDocumentStore(CountDocumentsTest, WriteDocumentsTest, DeleteDocumentsTest):
    ...
    @patch("deepstack_integrations.document_stores.qdrant.document_store.reciprocal_rank_fusion")
