# Install required packages for this example, including qdrant-deepstack and other libraries needed
# for Markdown conversion and embeddings generation. Use the following command:
# pip install qdrant-deepstack markdown-it-py mdit_plain sentence-transformers
