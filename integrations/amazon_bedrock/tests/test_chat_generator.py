...
from deepstack_integrations.components.generators.amazon_bedrock.chat.adapters import (
...
KLASS = "deepstack_integrations.components.generators.amazon_bedrock.chat.chat_generator.AmazonBedrockChatGenerator"
...
def test_to_dict(mock_boto3_session):
    ...
    expected_dict = {
        ...
        "init_parameters": {
            ...
            "generation_kwargs": {"temperature": 0.7},
            "stop_words": [],
            "streaming_callback": "deepstack.components.generators.utils.print_streaming_chunk",
        },
    }
