...
from deepstack_integrations.components.generators.amazon_bedrock.adapters import (
...
def test_to_dict(mock_boto3_session):
    ...
    expected_dict = {
        "type": "deepstack_integrations.components.generators.amazon_bedrock.generator.AmazonBedrockGenerator",
        "init_parameters": {
