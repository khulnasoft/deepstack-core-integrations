...
from deepstack_integrations.components.generators.mistral.chat.chat_generator import MistralChatGenerator
...
class TestMistralChatGenerator:
    ...
    def test_to_dict_default(self, monkeypatch):
        ...
        assert data == {
            "type": "deepstack_integrations.components.generators.mistral.chat.chat_generator.MistralChatGenerator",
            "init_parameters": {
