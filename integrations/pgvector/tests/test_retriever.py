...
class TestRetriever:
    ...
    def test_to_dict(self, mock_store):
        ...
        t = "deepstack_integrations.components.retrievers.pgvector.embedding_retriever.PgvectorEmbeddingRetriever"
        assert res == {
            "type": t,
            "init_parameters": {
                "document_store": {
    ...
    def test_from_dict(self, monkeypatch):
        ...
        data = {
            ...
            "init_parameters": {
                "document_store": {
                    ...
                    "init_parameters": {
                        "connection_string": {"env_vars": ["PG_CONN_STR"], "strict": True, "type": "env_var"},
                        "table_name": "deepstack_test_to_dict",
                        "embedding_dimension": 768,
                        "vector_function": "cosine_similarity",
                        "recreate_table": True,
                        "search_strategy": "exact_nearest_neighbor",
        ...
        assert document_store.table_name == "deepstack_test_to_dict"
