...
# Install required packages for this example, including pgvector-deepstack and other libraries needed
# for Markdown conversion and embeddings generation. Use the following command:
# pip install pgvector-deepstack markdown-it-py mdit_plain "sentence-transformers>=2.2.0"
