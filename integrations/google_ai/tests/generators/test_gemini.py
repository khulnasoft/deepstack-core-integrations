...
def test_init(monkeypatch):
    ...
    with patch("deepstack_integrations.components.generators.google_ai.gemini.genai.configure") as mock_genai_configure:
...
def test_to_dict(monkeypatch):
    ...
    with patch("deepstack_integrations.components.generators.google_ai.gemini.genai.configure"):
        gemini = GoogleAIGeminiGenerator(
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=[tool],
    ...
    assert gemini.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_ai.gemini.GoogleAIGeminiGenerator",
        "init_parameters": {
