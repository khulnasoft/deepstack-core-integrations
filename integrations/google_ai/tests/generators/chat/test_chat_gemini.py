...
from deepstack.dataclasses.chat_message import ChatMessage
...
def test_init(monkeypatch):
    ...
    with patch(
        "deepstack_integrations.components.generators.google_ai.chat.gemini.genai.configure"
...
def test_to_dict(monkeypatch):
    ...
    with patch("deepstack_integrations.components.generators.google_ai.chat.gemini.genai.configure"):
        gemini = GoogleAIGeminiChatGenerator(
            generation_config=generation_config,
            safety_settings=safety_settings,
            tools=[tool],
    ...
    assert gemini.to_dict() == {
        "type": "deepstack_integrations.components.generators.google_ai.chat.gemini.GoogleAIGeminiChatGenerator",
        "init_parameters": {
