...
from deepstack_integrations.components.embedders.optimum import OptimumTextEmbedder
...
class TestOptimumTextEmbedder:
    ...
    def test_to_and_from_dict(self, mock_check_valid_model, mock_get_pooling_mode):  # noqa: ARG002
        ...
        assert data == {
            "type": "deepstack_integrations.components.embedders.optimum.optimum_text_embedder.OptimumTextEmbedder",
            "init_parameters": {
