...
from deepstack_integrations.components.embedders.optimum import OptimumDocumentEmbedder
from deepstack_integrations.components.embedders.optimum.pooling import OptimumEmbedderPooling
from deepstack_integrations.components.embedders.optimum.optimization import (
    OptimumEmbedderOptimizationConfig,
    OptimumEmbedderOptimizationMode,
)
from deepstack_integrations.components.embedders.optimum.quantization import (
...
def mock_check_valid_model():
    with patch(
        "deepstack_integrations.components.embedders.optimum._backend.check_valid_model",
...
def mock_get_pooling_mode():
    with patch(
        "deepstack_integrations.components.embedders.optimum._backend._pooling_from_model_config",
...
class TestOptimumDocumentEmbedder:
    ...
    def test_to_and_from_dict(self, mock_check_valid_model, mock_get_pooling_mode):  # noqa: ARG002
        ...
        assert data == {
            "type": "deepstack_integrations.components.embedders.optimum.optimum_document_embedder.OptimumDocumentEmbedder",
            "init_parameters": {
