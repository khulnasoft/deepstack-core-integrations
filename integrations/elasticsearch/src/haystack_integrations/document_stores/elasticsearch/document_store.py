...
from deepstack.version import __version__ as deepstack_version
...
class ElasticsearchDocumentStore:
    ...
    ```python
    from deepstack.document_store.elasticsearch import ElasticsearchDocumentStore
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._client = Elasticsearch(
            hosts,
            headers={"user-agent": f"deepstack-py-ds/{deepstack_version}"},
            **kwargs,
        )
        self._index = index
